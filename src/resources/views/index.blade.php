...
<form class="form" action="{{ route('contacts.confirm') }}" method="POST">
  ...
  <div class="form__group">
    <div class="form__title">お名前<span class="form__title--required">※</span></div>
  ...
  <div class="form__group">
    <div class="form__title">性別<span class="form__title--required">※</span></div>
    <div class="form__group-content">
  ...
  <div class="form__group">
    <div class="form__title">メールアドレス<span class="form__title--required">※</span></div>
    <div class="form__group-content">
  ...
  <div class="form__group">
    <div class="form__title">電話番号<span class="form__title--required">※</span></div>
    <div class="form__group-content">
  ...
  <div class="form__group">
    <div class="form__title">住所<span class="form__title--required">※</span></div>
    <div class="form__group-content">
      <div class="form__input-text">
  ...
  <div class="form__group">
    <div class="form__title">お問い合わせの種類<span class="form__title--required">※</span></div>
    <div class="form__group-content">
  ...
  <div class="form__group">
    <div class="form__title">お問い合わせ内容<span class="form__title--required">※</span></div>
    <div class="form__group-content">
